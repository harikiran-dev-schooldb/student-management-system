...
const InfoRow = ({ icon: Icon, label, value }: { icon: any, label: string, value: string }) => (
  <div className="flex items-center gap-3 text-sm">
    ...
    <div className="flex flex-col">
       ...
       <span className="font-medium text-gray-900 dark:text-gray-100 truncate max-w-[180px]" title={value}>
         {value}
       </span>
    </div>
  </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="grid grid-cols-2 gap-4 flex-1 lg:max-w-md">
            ...
            <div className={metricCardClass}>
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">{totalStudents}</h2>
            ...
            <div className={metricCardClass}>
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">{teacher._count.subjects}</h2>
                <span className="text-xs font-medium text-gray-500 uppercase">Subjects</span>
              </div>
            </div>
            ...
            <div className={metricCardClass}>
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">{teacher._count.lessons}</h2>
